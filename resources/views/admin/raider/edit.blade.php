...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        <form action="http://www.thmaoqiu.cn/saiyou/public/index.php/raider/edit" method="post" enctype="multipart/form-data">
            ...
            <input type="file" name="pic" placeholder="传入攻略缩略图"><br />
            <input type="submit">
        </form>
